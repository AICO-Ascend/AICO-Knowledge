...
- **404 张裁剪表格**（表格第一次成为"可插入的图"，不再只是 Markdown 文本）
...
**现状（2026-08-24）**：69 唯一论文 ｜ 682 裁剪图 + 404 裁剪表 + 4 公式截图 ｜ 479 LaTeX 公式（58 篇）｜ 1600+ MiniMax-M3 解读（全部裁剪图 = 图文联合解读）｜ 69 篇 6 段深读 ｜ 77 张坏字体/坏结构论文裁剪由 ar5iv 原图/手工区域保护 ｜ PDF 0 截断 ｜ 三铁律全绿。
