...
- **666 张裁剪单图**（不再是整页截图——每张 figure 独立裁剪，可直接插入报告）
...
**现状（2026-08-24）**：69 唯一论文 ｜ 666 裁剪图 + 390 裁剪表 + 4 公式截图 ｜ 479 LaTeX 公式（58 篇）｜ 1600+ MiniMax-M3 解读（全部裁剪图 = 图文联合解读）｜ 69 篇 6 段深读 ｜ 54 张坏字体/坏结构论文裁剪由 ar5iv 原图保护 ｜ PDF 0 截断 ｜ 三铁律全绿。
