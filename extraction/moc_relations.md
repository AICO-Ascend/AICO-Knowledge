...
- **HybridFlow**（[[hybridflow-a-flexible-and-efficient-rlhf-framework]]，#30）/ **AREAL**（[[areal-a-large-scale-asynchronous-reinforcement-learning-system-for-language-reasoning]]，#33）：统一灵活 RLHF 框架 / 大规模异步 RL 系统。R1 的 RL 框架（四模块解耦 Rollout/Inference/Rule-Reward/Training + vLLM + DualPipe + 异步调度）是同期工业级 RLHF 基础设施；rule-based reward 异步 overlap 与 AREAL 异步 rollout 同源。
