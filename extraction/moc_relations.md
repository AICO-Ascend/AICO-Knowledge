...
- **AREAL**（[[areal-a-large-scale-asynchronous-reinforcement-learning-system-for-language-reasoning]]，#33）：大规模异步 RL 系统——打破同步 barrier、长 horizon reasoning 场景。与 HybridFlow 对比轴：大规模吞吐 vs 灵活表达；HybridFlow 的 data future + ResourcePool 是 AREAL 异步 pipeline 的同步版前身。
