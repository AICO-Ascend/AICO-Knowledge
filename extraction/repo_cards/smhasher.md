...
| 项 | 值 |
|---|---|
| 仓库 | https://gitcode.com/xLLM-AI/smhasher.git |
| 分支 / HEAD | `main` @ `651b433f9bd3` (2025-08-14) |
| 最新 tag | `None` |
| 版本候选 |
  - (未检出)
| 文件数 / md 文档 / 图片 | 1 / 1 / 0 |
| 语言分布 | {"Markdown": 1} |
| 备注 | Hash function quality and speed tests. |
...
- 文档收割: extraction/repo_docs/smhasher/ (1 篇)
