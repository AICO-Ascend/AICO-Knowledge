...
- `bookshelf/ascend_infra.md` — AscendInfra 昇腾专区：同一主线 L6→L1 自下而上展开 + 知识对照表（可视化↔深读↔仓实现三方互证）+ AscendV 引用地图 + 134 仓全景
...
**铁律**：
- **只改 CURATION.md，永不手改 SHELF.md/ascend_infra.md**（产物头部有 GENERATED 标记）
...
SHELF.md 142 条目（69/69 论文全覆盖）· ascend_infra.md 193 条目（134 仓 9 族分组全归位）· 0 死链。
